...
import { logoutFun } from '../../../redux/reducer/login.reducer';
import $ from 'jquery'
...
function TopBar() {
    ...
    return (
        <>
            <nav className="navbar navbar-expand navbar-light bg-white-topbar topbar static-top shadow">
                ...
                <div className="modal-dialog" role="document">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            <button className="btn btn-secondary" id='cancle' type="button" data-dismiss="modal">Cancel</button>
                            <Link to="" className="btn btn-primary" href="login.html"onClick={()=>handleLogout()}>Logout</Link>
                        </div>
                    </div>
                </div>
            </div>
