...
function ServicePage() {
    ...
    const MenuColumn = [
...

        {
            ...
            render: (text, record) => (
                <span><i className="fa fa-eye p-2  rounded-circle " style={{ color: 'white', backgroundColor: 'black' }} id={record.id} onClick={MenuView}></i><span className="p-2  rounded-circle "><Switch defaultChecked style={{ color: 'white', backgroundColor: 'black' }} id={record.id} onClick={MenuEdit} /></span><i className="fa fa-trash p-2  rounded-circle " style={{ color: 'white', backgroundColor: 'black' }} id={record.id} onClick={MenuDelete}></i></span>
            )
        },
    ]
    const MenuView = (e) => {
