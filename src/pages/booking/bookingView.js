                ...
                <div className='container-fluid'>
                    <div className='row '>
                        <div className='col-md-12 ' >
                            <div class="card">
                                <div className='card-header bold' onClick={() => navigate(-1)}><span className="px-2"><MdOutlineArrowBackIos /></span>View Booking Details</div>
                                    ...
                                    <table className='table'>
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><input readOnly="true" type="text" className='form-control'  /></td>
                                                <th>Date</th>
                                                <td><input readOnly="true" type="date" className='form-control'  /></td>
                                            </tr>
                                        </tbody>
                                    </table>
